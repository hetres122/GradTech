...
{
    /// <inheritdoc />
    public partial class CalculateTotalAmountToReservation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
        CREATE FUNCTION dbo.CalculateTotalAmountToReservations
        (
            @UnitId BIGINT,
            @StartDate DATE,
            @EndDate DATE
        ...
        {
            migrationBuilder.Sql("DROP FUNCTION dbo.GetTotalAmountForReservation;");    
        }
    }
}
